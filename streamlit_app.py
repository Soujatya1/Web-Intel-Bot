...
web_url = st.text_input("Enter a website URL to analyze:")
...
elif st.session_state.vectorstore is None and web_url:
    st.info("Process a website first before asking questions.")
elif not groq_api_key and web_url:
